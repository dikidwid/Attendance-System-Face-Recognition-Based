    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"D:\College\Python\Attendance-Management-system-using-face-recognition-master\Attendance-Management-system-using-face-recognition-master/Attendance(Manually)"'
                )
